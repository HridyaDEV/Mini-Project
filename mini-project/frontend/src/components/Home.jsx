    ...
    return (
        <>
            <div>
                ...
                <nav className='mt-5' >
                    ...
                    <ul className='flex justify-end gap-10 me-10'>
                        ...
                        <button className=' w-15 text-center border border-transparent hover:border-black cursor-pointer' onClick={() => navigate("/login")}>Login</button>
                    </ul>
                </nav>
            </div>
            {/* Hero Section */}
            <div className="bg-black text-white flex flex-col items-center justify-center h-78 mt-4 px-4 text-center">
                ...
                <button
                    className="bg-blue-500 text-white font-medium px-6 py-2 rounded-lg shadow-md hover:bg-blue-600 transition duration-300"
            ...
            <div className="py-12 bg-gray-100 text-center px-6 ">
                ...
                <p className="text-gray-700 max-w-3xl mx-auto mt-3 text-lg">
